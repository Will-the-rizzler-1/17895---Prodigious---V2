...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -6.494; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2.449; // x position of the perpendicular encoder (in tick units)
    }
