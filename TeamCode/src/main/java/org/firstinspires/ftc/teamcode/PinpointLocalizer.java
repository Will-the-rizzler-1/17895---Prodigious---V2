...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 3268; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1313; // x position of the perpendicular encoder (in tick units)
    }
